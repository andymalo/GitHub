...
btnViewAll = Button(window, text = "View All",width = 12, command = backend.viewAll)
btnViewAll.grid(row=3,column=4)

btnSearchE = Button(window, text = "Search Entry",width = 12, command =backend.searchEntry)
btnSearchE.grid(row=4,column=4)

btnAddE = Button(window, text = "Add Entry",width = 12, command =backend.addEntry)
btnAddE.grid(row=5,column=4)

btnUpdate = Button(window, text = "Update",width = 12, command =backend.updateEntry)
btnUpdate.grid(row=6,column=4)

btnDelete = Button(window, text = "Delete",width = 12, command =backend.delEntry)
btnDelete.grid(row=7,column=4)

btnViewAll = Button(window, text = "Close",width = 12, command =backend.close)
